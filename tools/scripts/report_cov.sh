...
lcov --rc lcov_branch_coverage=1 --remove ${OUTPUT}.info '*test/*' '*tools/*' '*ext/*' '*fuzzing/*' '/usr/include/*' '*src/nextToken.re2c.cpp' '*nextToken.cpp' --output-file ${OUTPUT}-cleaned.info
