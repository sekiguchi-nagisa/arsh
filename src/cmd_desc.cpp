...
static constexpr BuiltinCmdDesc table[] = {
    ...
    {"echo", "[-neE] [arg ...]",
     ...
     "        \\unnnn      N is hex number. NNNN can be 1 to 4 number\n"
     "        \\Unnnnnnnn  N is hex number. NNNNNNNN can be 1 to 8 number\n"
    ...
    {"test", "[expr]",
     ...
     "  STRING1 < STRING2   check if STRING1 is less than STRING2 with dictionary order\n"
     "  STRING1 > STRING2   check if STRING2 is greater than STRING2 with dictionary order\n"
     "\n"
     "Integer operators:\n"
