...
static const struct Interval zero_width_table[] = {
    ...
    { 0x110B9, 0x110BA }, { 0x110BD, 0x110BD }, { 0x11100, 0x11102 }, { 0x11127, 0x1112B },
    ...
    { 0x11727, 0x1172B }, { 0x11A01, 0x11A06 }, { 0x11A09, 0x11A0A }, { 0x11A33, 0x11A38 },
...
static const struct Interval two_width_table[] = {
    ...
    { 0x302E, 0x303E }, { 0x3041, 0x3096 }, { 0x309B, 0x30FF }, { 0x3105, 0x312E },
    ...
    { 0xFF01, 0xFF60 }, { 0xFFE0, 0xFFE6 }, { 0x16FE0, 0x16FE1 }, { 0x17000, 0x187EC },
    { 0x18800, 0x18AF2 }, { 0x1B000, 0x1B11E }, { 0x1B170, 0x1B2FB }, { 0x1F004, 0x1F004 },
