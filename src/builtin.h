...
//!bind: function match($this: Regex, $target : String, $timeout: Option<Int>) : Option<RegexMatch>
...
//!bind: function replace($this: Regex, $target : String, $repl : String, $once: Option<Bool>, $timeout: Option<Int>) : String
