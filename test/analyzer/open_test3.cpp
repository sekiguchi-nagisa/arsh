...
INSTANTIATE_TEST_SUITE_P(OpenTest3_cli, OpenTest,
                         ::testing::ValuesIn(findExecTestCasesFromDir(EXEC_TEST_DIR "/cli")));

INSTANTIATE_TEST_SUITE_P(OpenTest3_module, OpenTest,
                         ::testing::ValuesIn(findExecTestCasesFromDir(EXEC_TEST_DIR "/module")));

INSTANTIATE_TEST_SUITE_P(OpenTest3_syntax, OpenTest,
                         ::testing::ValuesIn(findExecTestCasesFromDir(EXEC_TEST_DIR "/syntax")));

INSTANTIATE_TEST_SUITE_P(OpenTest3_output, OpenTest,
                         ::testing::ValuesIn(findExecTestCasesFromDir(EXEC_TEST_DIR "/output")));
