...
public:
    HistoryTest() {
        ...
        DSState_loadModule(this->state, HISTORY_MOD_PATH, 0, nullptr);
    ...
    void addHistory(const char *value) {
        DSState_lineEdit(this->state, DS_EDIT_HIST_ADD, 0, &value);
    }

    void clearHistory() {
        DSState_lineEdit(this->state, DS_EDIT_HIST_CLEAR, 0, nullptr);
    }
