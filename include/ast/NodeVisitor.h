...
public:
    ...
    virtual int visitTupleNode(TupleNode *node) = 0;
    ...
    virtual int visitCmdNode(CmdNode *node) = 0;
    virtual int visitCmdArgNode(CmdArgNode *node) = 0;
    virtual int visitSpecialCharNode(SpecialCharNode *node) = 0;
    virtual int visitPipedCmdNode(PipedCmdNode *node) = 0;
    virtual int visitCmdContextNode(CmdContextNode *node) = 0;
    ...
    virtual int visitDummyNode(DummyNode *node) = 0;
};
